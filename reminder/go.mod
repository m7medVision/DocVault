module github.com/docvault/reminder
...
require (
	...
	go.opentelemetry.io/otel v1.39.0 // OpenTelemetry core
	...
	go.opentelemetry.io/otel/metric v1.39.0 // OpenTelemetry metrics
	...
	go.opentelemetry.io/otel/trace v1.39.0 // OpenTelemetry tracing
